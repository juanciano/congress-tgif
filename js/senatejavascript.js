...
fetchJson('https://api.propublica.org/congress/v1/113/senate/members.json', myInit)
.then(function(json){
  data = json;
  getData();
});
...
function getData(){
  ...
  document.getElementById("senate_data").innerHTML = data.results[0].members.map(
  ...
  document.getElementById("senate_data").innerHTML = tableData
  ...
  document.getElementById("R").addEventListener("click", function() {
    document.getElementById("senate_data").innerHTML = filterMembers()
  });
